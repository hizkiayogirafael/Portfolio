...
import satu from "../../Assets/Frontend/Ilventory/satu.png";
import dua from "../../Assets/Frontend/Ilventory/dua.jpg";
  ...
  return (
    <div className="w-fit-screen h-fit bg-black text-white font-manrope px-[25px] lg:px-[170px]">
      ...
      <div className="w-full h-fit flex flex-row justify-between items-end mt-4 lg:pb-2">
        <h1 className="text-[18px] lg:text-[40px]">Il-Ventory</h1>
      ...
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <a
          href="https://github.com/hizkiayogirafael/Inventory-System-IL-Fe.git"
          className="lg:text-[20px] text-[10px] text-right hover:text-gray-500"
        >
          https://github.com/hizkiayogirafael/Inventory-System-IL-Fe.git
        </a>
      </div>
      <hr className="opacity-30 text-white" />
      {/* FE Github */}
      <div className="flex flex-row justify-between py-2 items-center">
        <a className="lg:text-[25px] text-[12px]">BE Github</a>
        <a
          href="https://github.com/hizkiayogirafael/Inventory-System-IL-Be.git"
          className="lg:text-[20px] text-[10px] text-right hover:text-gray-500"
        >
          https://github.com/hizkiayogirafael/Inventory-System-IL-Be.git
        </a>
      </div>
      <hr className="opacity-30 text-white" />
      {/* Figma */}
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <a
          href="https://www.figma.com/design/2SVWk8WYgdi12y8AC0wZ6M/Ui-Design?node-id=141-120&t=4isJyjlvVmbKDTtX-1"
          className="lg:text-[20px] text-[10px] text-right hover:text-gray-500"
        >
          Open Figma Here
        </a>
      ...
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <h1 className="lg:text-[20px] text-[10px] text-right">
          Visual Studio Code, HTML, TailwindCSS, ReactJS, ExpressJs, NodeJs,
          MySQL
        </h1>
      </div>
      <hr className="opacity-30 text-white" />
