...
import satu from "../../Assets/Fullstack/Notes/satu.jpg";
import dua from "../../Assets/Fullstack/Notes/dua.jpg";
  ...
  return (
    <div className="w-fit-screen h-fit bg-black text-white font-manrope px-[25px] lg:px-[170px]">
      ...
      <h1 className="text-[11px] pb-2 lg:text-[20px] lg:pb-4">
        Description : This project is a simple web application created as part
        of the MSIB (Magang Studi Independen Bersertifikat) program to
        demonstrate the implementation of CRUD (Create, Read, Update, Delete)
        operations. The application is designed to manage notes and is built
      ...
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <a
          href="https://github.com/hizkiayogirafael/Api-Backend.git"
          className="lg:text-[20px] text-[10px] text-right hover:text-gray-500"
        >
          https://github.com/hizkiayogirafael/Api-Backend.git
        </a>
      </div>
      <hr className="opacity-30 text-white" />
      {/* Figma */}
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <a className="lg:text-[20px] text-[10px] text-right hover:text-gray-500">
          None
        </a>
      </div>
      <hr className="opacity-30 text-white" />
      ...
      <div className="flex flex-row justify-between py-2 items-center">
        ...
        <h1 className="lg:text-[20px] text-[10px] text-right">
          Visual Studio Code, ExpressJs, NodeJs, REST Client, MySQL, MySQL
          Workbench
        </h1>
      </div>
      <hr className="opacity-30 text-white" />
